...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-paper-100 overflow-hidden border-b-8 border-primary-500">
      ...
      >
        <path
          d="M44.7,-76.4C58.8,-69.2,71.8,-59.1,81.4,-46.3C91,-33.5,97.2,-18,97.6,-2.4C98,13.2,92.5,28.9,83.8,42.5C75.1,56.1,63.1,67.6,49.1,76.5C35.1,85.4,19.1,91.7,2.5,87.3C-14.1,82.9,-31.2,67.8,-46.3,55.1C-61.4,42.4,-74.5,32.1,-82.9,18C-91.3,3.9,-95,-14,-90.4,-29.4C-85.8,-44.8,-72.9,-57.7,-58.5,-64.8C-44.1,-71.9,-28.2,-73.2,-13,-76.6C2.2,-80,24.3,-85.5,44.7,-76.4Z"
      ...
      >
        <path
          d="M49.4,-72C64.3,-62.4,76.8,-48.9,85.5,-32.9C94.2,-16.9,99.1,1.6,95.3,18.7C91.5,35.8,79,51.5,63.9,62.9C48.8,74.3,31.1,81.4,12.7,85.2C-5.7,89,-24.8,89.5,-42.2,82.8C-59.6,76.1,-75.3,62.2,-85.2,45C-95.1,27.8,-99.2,7.3,-95.4,-11.5C-91.6,-30.3,-79.9,-47.4,-64.8,-57.8C-49.7,-68.2,-31.2,-71.9,-14.2,-74.6C2.8,-77.3,25.6,-79,49.4,-72Z"
          transform="translate(100 100)"
        />
      </svg>
        ...
        >
          <div className="w-full md:w-[55%] flex flex-col items-center md:items-start text-center md:text-left relative">
            ...
            <motion.h1
              ...
              className="font-display font-bold text-primary-950 text-4xl md:text-5xl lg:text-7xl"
            >
              {renderHeadline(home.hero.headline)}
            </motion.h1>
            <motion.p
              variants={itemVariants}
              className="font-body text-lg md:text-xl text-slate-600 max-w-[600px] mt-4"
            >
          ...
          >
            <div className="relative max-w-[280px] md:max-w-[380px] w-full">
              <div
                className="absolute -top-4 left-1/4 w-20 h-8 bg-accent-500 opacity-90 -rotate-6 z-20"
                style={{ clipPath: "polygon(5% 0, 95% 5%, 100% 95%, 0 100%)" }}
              ></div>
              <div
                className="absolute -bottom-6 right-1/4 w-20 h-8 bg-secondary-500 opacity-90 rotate-6 z-20"
