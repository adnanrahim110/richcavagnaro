...
export function AuthorHero() {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center bg-gradient-to-br from-primary-50 via-white to-accent-50 overflow-hidden py-20">
      {/* Decorative Blobs */}
      <svg className="absolute top-0 left-0 w-96 h-96 text-primary-100 fill-current opacity-40 pointer-events-none -translate-x-1/3 -translate-y-1/3" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg className="absolute bottom-0 right-0 w-[500px] h-[500px] text-accent-100 fill-current opacity-30 pointer-events-none translate-x-1/4 translate-y-1/4" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg className="absolute top-1/2 right-1/4 w-64 h-64 text-primary-100 fill-current opacity-30 pointer-events-none -translate-y-1/2" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
